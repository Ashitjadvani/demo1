...
import {EventHelper, PaginationModel} from "../../../../../../../fe-common-v2/src/lib";
...
@Component({
  selector: 'app-procurement-list-template',
  templateUrl: './procurement-list-template.component.html',
  styleUrls: ['./procurement-list-template.component.scss']
})
export class ProcurementListTemplateComponent implements OnInit {
    ...
    async getTemplateListData(request): Promise<void> {
        ...
        const res: any = await this.ApiService.getProcurementTemplateList(this.requestPara);
