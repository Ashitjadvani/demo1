...
@Component({
    selector: 'app-scan-product-returnal',
    templateUrl: './scan-product-returnal.component.html',
    styleUrls: ['./scan-product-returnal.component.scss']
})
export class ScanProductReturnalComponent implements OnInit {
