...
import {selectEntityStore} from '../../../recruiting/store/selectors';
import {Store} from '@ngrx/store';
import {MatDialog, MatDialogConfig} from '@angular/material/dialog';
import {FiltersDialogComponent} from '../filtering/filters-dialog/filters-dialog.component';
import {ColumnTemplate} from '../models';
...
export class TableDataViewComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  openFiltersDialog(): void {
    ...
    const dialogRef = this.dialog.open(FiltersDialogComponent, config);
