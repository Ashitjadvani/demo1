...
export class CompanyFunctionsGroupsResponse extends BaseResponse {
    functions: any[];
}
...
export class AdminUserManagementService {
    ...
    async getUserInfo(userId: string): Promise<any> {
        return await this.apiService.get<any>("/v2/user-manager/person/" + userId).toPromise();
    }
    ...
    async uploadUsers(users: any[], companyId: string): Promise<any> {
        //let url = isSafetyUsers ? this.apiService.API.ADMIN.UPLOAD_SAFETY_USERS : this.apiService.API.BE.UPLOAD_USERS;
        //return this.apiService.uploadFile(file, url).toPromise();
        let bodyRequest = {
            users: users,
        ...
        return this.apiService.post<BaseResponse>(this.apiService.API.BE.UPLOAD_USERS, bodyRequest).toPromise();
    }

    async uploadUsersList(users: any[], companyId: string, scope: string): Promise<any> {
        let bodyRequest = {
            users: users,
            companyId: companyId,
            scope: scope
    ...
    async getPeopleForEdit(companyId: string): Promise<PeopleGroupResponse> {
        var parameter = {
            id: companyId
        }
        return await this.apiService.post<PeopleGroupResponse>(this.apiService.API.BE.GET_PERSON_FOR_EDIT, parameter).toPromise();
    }

    async getPeopleAccountForEdit(companyId: string): Promise<PeopleGroupResponse> {
        var parameter = {
            id: companyId
        }
        return await this.apiService.post<PeopleGroupResponse>(this.apiService.API.BE.GET_PERSON_ACCOUNT_FOR_EDIT, parameter).toPromise();
    }

    async getPeopleGroupForEdit(id: string): Promise<PeopleGroupResponse> {
        var parameter = {
            id: id
        }
        return await this.apiService.post<PeopleGroupResponse>(this.apiService.API.BE.GROUP_EDIT_PEOPLE, parameter).toPromise();
    }
    ...
    // PERSON API
    async getPeople(companyId: string, data: any): Promise<PeopleResponse> {
        let url = buildRequest(this.apiService.API.BE.GET_PEOPLE_BY_COMPANY,
            {
                ':companyId': companyId
            });
        return await this.apiService.post<PeopleResponse>(url, data).toPromise();
    }

    // PERSON EVENT API
    async getEventPeople(companyId: string, data: any): Promise<PeopleResponse> {
        let url = buildRequest(this.apiService.API.BE.GET_PEOPLE_BY_EVENT_COMPANY,
            {
                ':companyId': companyId
            });
        return await this.apiService.post<PeopleResponse>(url, data).toPromise();
    ...
    // PERSON API
    async getPeopleList(companyId: string): Promise<PeopleResponse> {
        let url = buildRequest(this.apiService.API.BE.GET_PEOPLE,
            {
                ':companyId': companyId
            });
    ...
    async getPeopleWaitingAccountList(companyId: string): Promise<PeopleResponse> {
        let url = this.apiService.API.BE.GET_PEOPLE_WAITING_ACCOUNT;
        return await this.apiService.get<PeopleResponse>(url).toPromise();
    }
    ...
    // ACCOUNT API
    async getAccounts(companyId: string, data): Promise<AccountResponse> {
        let url = buildRequest(this.apiService.API.BE.GET_ACCOUNTS_BY_COMPANY,
            {
                ':companyId': companyId
            });
        return await this.apiService.post<AccountResponse>(url, data).toPromise();
    }
    ...
    async getCompanyFunctionsByGroups(): Promise<CompanyFunctionsGroupsResponse> {
        return await this.apiService.get<CompanyFunctionsGroupsResponse>(this.apiService.API.BE.GET_COMPANY_FUNCTIONS_BY_GROUPS).toPromise();
    }
    ...
    addCompanyScope(companyId: string, scope: any): Observable<BaseResponse> {
        let url = buildRequest(this.apiService.API.BE.ADD_COMPANY_SCOPE,
            {
                ':id': companyId
            });
        return this.apiService.post<BaseResponse>(url, scope);
    }

    updateCompanyScope(companyId: string, scopeName: string, scope: any): Promise<BaseResponse> {
    ...
    getScopeByName(companyId: string, scopeName: string): Observable<BaseResponse> {
        let url = buildRequest(this.apiService.API.BE.COMPANY_SCOPE,
            {
                ':id': companyId,
                ':scopeName': scopeName
            });
        return this.apiService.get<BaseResponse>(url);
    }
    ...
    async addUpdateDocument(doc: any): Promise<any> {
        return await this.apiService.post<any>(this.apiService.API.BE.ADD_UPDATE_STAFF_DOCUMENT, doc).toPromise();
    }


    // USER DOCUMENTS

    async getUserDocuments(data: any): Promise<any> {
        return await this.apiService.post<any>(this.apiService.API.BE.GET_USER_DOCUMENTS, data).toPromise();
    }

    async addUpdateUserDocument(userDoc: UserDocument): Promise<any> {
        return await this.apiService.post<any>(this.apiService.API.BE.ADD_UPDATE_USER_DOCUMENT, userDoc).toPromise();
    }
    ...
    updateUserActivity(userActivity: UserDailyActivity) {
        return this.apiService.put<BaseResponse>(this.apiService.API.BE.USER_ACTION_UPDATE, userActivity).toPromise();
    }
