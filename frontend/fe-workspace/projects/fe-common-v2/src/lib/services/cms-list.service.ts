...
export class CMSManagementService {
  ...
  //   return this.apiService.post(this.apiService.API.BE.CMS_DETAILS, data)
  // }

  // async getCMSDetails(data: any): Promise<Request[]> {
  //   return this.apiService.post<Request[]>(this.apiService.API.BE.CMS_DETAILS, data).toPromise();
  // }
