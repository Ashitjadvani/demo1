...
import {SiteResponse} from "./admin-site-management.service";
...
export class TouchpointManagementService {
    ...
    getTouchPointList(data: any): Promise<TouchPointListResult> {
        return this.apiService.post<TouchPointListResult>(this.apiService.API.BE.TOUCHPOINT_LIST, data).toPromise();
    }

  // getScopes(data: any): Promise<TouchPointListResult> {
  //   return this.apiService.post<TouchPointListResult>(this.apiService.API.BE.GET_FULL_SITE_LIST, data).toPromise();
  // }
  ...
  async getCompany(companyId: string): Promise<CompanyResponse> {
    ...
    async deleteTouchpoints(id: any): Promise<RecruitingCandidateDocument[]> {
