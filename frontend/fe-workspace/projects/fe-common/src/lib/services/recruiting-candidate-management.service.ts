...
export class RecruitingCandidateManagementService {
  ...
  async getCandidateList(): Promise<RecruitingCandidateDocument[]> {
    return this.apiService.post<RecruitingCandidateDocument[]>(this.apiService.API.BE.RECRUITING_CANDIDATE_LISTING, null).toPromise();
  }
